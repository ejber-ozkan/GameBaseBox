...
describe('C64EditionGrid', () => {
  ...
  it('omits RECENT, FAVOURITES, and CLASSICS rails when a search query is active', () => {
    render(
      <C64EditionGrid
  ...
  it('renders only the first alphabet section cards when activeAlphabetRailId is null (preventing full library DOM explosion)', () => {
    render(
      <C64EditionGrid
