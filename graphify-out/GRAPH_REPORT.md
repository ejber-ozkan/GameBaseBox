...
## Corpus Check
- 158 files · ~119,964 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1693 nodes · 3506 edges · 90 communities (81 shown, 9 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 70 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `08e7ae88`
...
Cohesion: 0.20
Nodes (13): ERROR_SOUNDS, UiSoundRuntime(), POPUP_SOUNDS, areMenuSoundEffectsEnabled(), audioCache, canPlayUiSoundEffects(), getAudioElement(), getNextRotatingUiSoundEffect() (+5 more)
...
Cohesion: 0.20
Nodes (7): Settings, LETTER_RAIL_CACHE, UseBigBoxLibraryDataProps, PLATFORM_EMULATOR_PROFILES, LaunchSource, PlatformLaunchSettings, LaunchRequest
...
Cohesion: 0.10
Nodes (25): DETAIL_CONFIG, detailCache, DetailFullscreenMedia, DetailFullscreenRequest, DetailView(), DetailViewProps, getCachedGameDetail(), WasmPlayer() (+17 more)

### Community 23 - "Community 23"
Cohesion: 0.08
Nodes (40): BigBoxExitPrompt(), ControllerSearchKeyboard(), ExtrasBigscreenNavigation, ExtrasDetail(), ExtrasDetailProps, ImageWithFallback(), AUDIO_EXTENSIONS, isAudioExtra() (+32 more)
...
Cohesion: 0.13
Nodes (18): MusicianPhoto(), MusicianPhotoProps, MusicPlayer(), isNativePath(), resolvePlayableSapUrl(), SapPlayer(), SapPlayerProps, SapPlayerRuntime (+10 more)
...
Cohesion: 0.15
Nodes (18): BigBoxHeader(), BigBoxHeaderProps, BigBoxViewProps, MusicPlayerProps, PlatformSwitcher(), PlatformSwitcherProps, SettingsContextType, BIGBOX_LETTERS (+10 more)
...
Cohesion: 0.13
Nodes (16): BigBoxFooter(), BigBoxFooterProps, BigBoxSessionState, BigBoxView(), SubGenrePickerModal(), SubGenrePickerModalProps, useBigBoxLibraryData(), useBigBoxNavigation() (+8 more)
...
Cohesion: 0.29
Nodes (8): BigBoxAlphabetRail(), BigBoxAlphabetRailProps, getTargetVisibleCards(), HorizontalRail(), HorizontalRailProps, BigBoxRailCategory, UseBigBoxNavigationProps, FullscreenLayoutMetrics
...
Cohesion: 0.12
Nodes (12): BigBoxExitPromptProps, ExitPromptFocus, ControllerSearchKeyboardProps, KEYBOARD_ROWS, KeyboardAction, KeyboardKey, GamepadButtonMap, GamepadHandlers (+4 more)
...
Cohesion: 0.07
Nodes (59): getCoverUrl(), ImageWithFallbackProps, getResolvedCoverArtUrl(), ActivePlatformStateResponse, assetUrlCache, cancelPlatformImport(), convertExtraVideo(), DatabaseBootstrapStatus (+51 more)
...
Cohesion: 0.10
Nodes (21): BigBoxTileMedia(), BigBoxTileMediaProps, COVER_CACHE, SCREENSHOT_CACHE, ListView(), ListViewProps, ScrapeButtonProps, mockGames (+13 more)
...
- **Why does `PlatformId` connect `Community 38` to `Detail View Layout & Navigation`, `Community 2`, `Community 34`, `Component 13`, `Community 23`, `Community 56`, `Community 57`, `Community 60`, `Community 31`?**
  _High betweenness centrality (0.010) - this node is a cross-community bridge._
